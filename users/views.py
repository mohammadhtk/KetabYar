...
from users.utils.generate_code import validate_code, generate_code
...
class UserViewSet(viewsets.GenericViewSet):
    ...
    def register(self, request):
        ...
        return Response({"message": "User created successfully. Please check your email to activate your account.", 'email': user.email}, status=status.HTTP_201_CREATED)
    ...
    def resend_activation(self, request):
        ...
        try:
            ...
            return Response({"message": "User created successfully. Please check your email to activate your account.", 'email': user.email}, status=status.HTTP_400_BAD_REQUEST)
        except User.DoesNotExist:
